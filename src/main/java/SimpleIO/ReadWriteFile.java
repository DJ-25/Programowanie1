...
public class ReadWriteFile {
    ...
    public boolean writeWithBufferedWriter(List<DataStorage> dataToWrite)
        ...
        for (DataStorage storage : dataToWrite) {
            file.write(storage.getIndex() + fieldSeparator + storage.getData1() + fieldSeparator
        ...
        try (BufferedReader reader = new BufferedReader(new FileReader("DataList.txt"))) {
            try {
                ...
                while ((input = reader.readLine()) != null) {
                    ...
                    DataStorage dataStorage = new DataStorage(index, dataLine[1], dataLine[2]);
                    dataStorageMap.put(index, dataStorage);
                }
